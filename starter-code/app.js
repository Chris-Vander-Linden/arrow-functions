...
// "this" references the joe object, which is an instance of the Student class.

// 2. What is "this" when joe.scopeArrow() is invoked?
//  "this" references the global Window object, which is the context the arrow function was created in.

// 3. Explain why "this" is different when an arrow function is used.
//  When a regular function is invoked, it resets the "this" context to its current context.
//  However, with an arrow function, the "this" context is not reset, so "this" still references the "this" context from where it was created.